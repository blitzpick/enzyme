...
if (_version.REACT013) {
  ...
  try {
    ...
    if (_version.REACT16) {
      throw new Error('react-dom@16+ and react-test-renderer are implicit dependencies when using ' + 'react@16+ with enzyme. Please add the appropriate version to your ' + 'devDependencies. See https://github.com/airbnb/enzyme#installation');
    } else if (_version.REACT155) {
